/* Replaces __BUILD_STAMP__ in the built sw.js with the app version, so each build
 * gets a fresh cache name and clients pick up the new bundle instead of a stale one. */
...
console.log(`[stamp-sw] ${outDir}/sw.js cache name stamped as hoken-${stamp}`)
